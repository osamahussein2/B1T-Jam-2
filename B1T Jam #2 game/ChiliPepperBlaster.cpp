#include "ChiliPepperBlaster.h"
#include "Window.h"
#include <iostream>

ChiliPepperBlaster::ChiliPepperBlaster() : PlantTower(PlantType::ChiliPepperBlaster)
{
	// Load chili pepper blaster
...
ChiliPepperBlaster::~ChiliPepperBlaster()
{
}

void ChiliPepperBlaster::update()
{
	// Update chili pepper blaster
...
void ChiliPepperBlaster::render()
{
	// Render chili pepper blaster
	SDL_RenderTextureRotated(Window::GetRenderer(), entityTexture, &srcEntity, &destEntity, 0.0, NULL,
		SDL_FLIP_NONE);
}

void ChiliPepperBlaster::moveEntity(Vector2 position)
{
}

void ChiliPepperBlaster::collision(Entity* other)
{
}

PlantType ChiliPepperBlaster::getPlantID() const
{
	return PlantType::ChiliPepperBlaster;
}