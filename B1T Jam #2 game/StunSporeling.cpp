...
void StunSporeling::moveEntity(Vector2 position)
{
}

void StunSporeling::collision(Entity* other)
{
}

AlienType StunSporeling::getAlienID() const
{
	return AlienType::StunSporeling;
}
